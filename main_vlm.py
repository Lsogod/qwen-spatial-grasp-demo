...
# - VLM_METHOD=qwen  -> use vision_agent (default, Qwen-first demo path)
# - VLM_METHOD=svp   -> use vision_agent_v2 (enhanced custom method path)
# Backward compatibility: if VLM_METHOD is not set, fallback to VLM_AGENT_IMPL.
_method_raw = os.getenv("VLM_METHOD") or os.getenv("VLM_AGENT_IMPL", "qwen")
